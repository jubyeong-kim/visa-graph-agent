...
|---|---|---|---|---|---|---|---|
| 1홉 | 11 | 6 | **8** | 70% | 28% | 0.32 | 8.2 |
| 2홉 | 13 | 8 | 8 | 55% | 8% | 0.13 | 10.9 |
| **3홉** | 5 | **5** | 1 | 87% | 17% | 0.28 | 16.0 |
| 전역 | 1 | 0 | 0 | — | — | — | — |
| 합계 | **30** | **19** | 17 | | | | |

**총점보다 홉별 분포가 이 표의 핵심이다.**

| 홉 | GraphRAG | BM25 | 차이 |
|---|---|---|---|
| 1홉 | 6/11 (55%) | **8/11 (73%)** | −18%p |
| 2홉 | 8/13 (62%) | 8/13 (62%) | 0 |
| **3홉** | **5/5 (100%)** | 1/5 (20%) | **+80%p** |

단순 조회는 키워드 검색이 이긴다. "90일" 이 적힌 문서를 통째로 읽으면 되니까.
**멀티홉은 그래프가 이긴다.** 3홉 5문항에서 5:2 다.

처음에는 골든셋이 12문항이었고 8:6 으로 이겼다. 30문항으로 늘리자 15:20 으로 **졌다**.
12문항이 우연히 그래프가 잘하는 쪽에 쏠려 있었던 것이다. 거기서 드러난 색인 구멍
(기한·기간 요건이 한 부류로 통째로 안 뽑힘)을 고쳐 18:18 까지 왔다.
자세한 것은 [REPORT.md](REPORT.md).
